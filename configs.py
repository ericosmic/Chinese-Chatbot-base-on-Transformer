...
tf.app.flags.DEFINE_string('data_path', './data_in/douban.csv', 'data path') #  데이터 위치
tf.app.flags.DEFINE_string('vocabulary_path', './data_cn_out/vocabularyData.voc', 'vocabulary path') # 사전 위치
tf.app.flags.DEFINE_string('check_point_path', './data_cn_out/check_point', 'check point path') # 체크 포인트 위치
